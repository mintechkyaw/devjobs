<div wire:poll.5s class="md:px-2 lg:px-32 py-10 grid grid-cols-7 space-x-3">
    <div class="col-span-7 md:col-span-5">
        ...
        <x-job-wrapper featured="{{$job->featured}}" href="/jobs/{{ $job->id }}">
            ...
            <div class="">
                ...
                <div class="text-md font-normal">{{ $job->employ_type }}</div>
    ...
    <div class="col-span-2 hidden md:block">
        <div class="sticky top-5">
            ...
            <div class="mt-4">
                <x-skill-tag :active="true" href="/" wire:navigate>
                    All Jobs
                </x-skill-tag>
